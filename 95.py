#https://www.youtube.com/watch?v=bOwyQlX_guo&list=PLto9KpJAqHMQNY3XP0JqLs7NyeU_dnNj0&index=169
#dailyTrackGenerator
...
{news['description']}
 """
    ...
    model="gpt-3.5-turbo",
    messages=[
        {"role": "system", "content": "Your an ai an take in new article titles and condenses them into 3 words using the format :'WORD WORD WORD'"},
